...
This document describes the structure and usage of the hexaGenApp GitHub Project Board used for tracking issues, workflows, and development progress.

---

## 🧭 Board Overview

The hexaGenApp project board is organized using GitHub Projects (v2) with the following columns:
